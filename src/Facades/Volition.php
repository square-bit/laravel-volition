 ...
 * @method static \Squarebit\Volition\Volition registerConditions(array|class-string<IsCondition> $conditions)
 * @method static \Squarebit\Volition\Volition registerActions(array|class-string<IsAction> $actions)
 */
